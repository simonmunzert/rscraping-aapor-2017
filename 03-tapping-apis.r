...
get_googlemap("Humboldt University, Berlin", zoom = 12, maptype = "hybrid") %>% ggmap()
ggmap_credentials()
...
credentials <- c(
  "twitter_api_key=rN3Td2zZNJSFJLEN9Pj7X2eBN",
  "twitter_api_secret=abcqBpUzE7BDNFJS378SKzpUzjyaRCfwn3ndrUUcqDWfhCN7Fj")
